...
class fun(minqlx.Plugin):
    ...
    def handle_chat(self, player, msg, channel):
        ...
        if _re_hahaha_yeah.match(msg):
            self.play_sound("sound/player/lucy/taunt.wav", player)
        elif _re_haha_yeah_haha.match(msg):
            self.play_sound("sound/player/biker/taunt.wav", player)
        elif _re_yeah_hahaha.match(msg):
            self.play_sound("sound/player/razor/taunt.wav", player)
        elif _re_duahahaha.match(msg):
            self.play_sound("sound/player/keel/taunt.wav", player)
        elif _re_hahaha.search(msg):
            self.play_sound("sound/player/santa/taunt.wav", player)
        elif _re_haahaahaa.search(msg):
            self.play_sound("sound/player/visor/taunt.wav", player)
        elif _re_glhf.match(msg):
            self.play_sound("sound/vo/crash_new/39_01.wav", player)
        elif _re_f3.match(msg):
            self.play_sound("sound/vo/crash_new/36_04.wav", player)
        elif "holy shit" in msg.lower():
            self.play_sound("sound/vo_female/holy_shit", player)
        elif _re_welcome.match(msg):
            self.play_sound("sound/vo_evil/welcome", player)
        elif _re_go.match(msg):
            self.play_sound("sound/vo/go", player)
        elif _re_beep_boop.match(msg):
            self.play_sound("sound/player/tankjr/taunt.wav", player)
        elif _re_win.match(msg):
            self.play_sound("sound/vo_female/you_win.wav", player)
        elif _re_lose.match(msg):
            self.play_sound("sound/vo/you_lose.wav", player)
        elif "impressive" in msg.lower():
            self.play_sound("sound/vo_female/impressive1.wav", player)
        elif "excellent" in msg.lower():
            self.play_sound("sound/vo_evil/excellent1.wav", player)
        elif _re_denied.match(msg):
            self.play_sound("sound/vo/denied", player)
        elif _re_balls_out.match(msg):
            self.play_sound("sound/vo_female/balls_out", player)
        elif _re_one.match(msg):
            self.play_sound("sound/vo_female/one", player)
        elif _re_two.match(msg):
            self.play_sound("sound/vo_female/two", player)
        elif _re_three.match(msg):
            self.play_sound("sound/vo_female/three", player)
        elif _re_fight.match(msg):
            self.play_sound("sound/vo_evil/fight", player)
        elif _re_gauntlet.match(msg):
            self.play_sound("sound/vo_evil/gauntlet", player)
        elif _re_humiliation.match(msg):
            self.play_sound("sound/vo_evil/humiliation1", player)
        elif _re_perfect.match(msg):
            self.play_sound("sound/vo_evil/perfect", player)
        elif _re_wah.match(msg):
            self.play_sound("sound/misc/yousuck", player)
        elif _re_ah.match(msg):
            self.play_sound("sound/player/slash/taunt.wav", player)
        elif _re_oink.match(msg):
            self.play_sound("sound/player/sorlag/pain50_1.wav", player)
        elif _re_argh.match(msg):
            self.play_sound("sound/player/doom/taunt.wav", player)
        elif _re_hah_haha.match(msg):
            self.play_sound("sound/player/hunter/taunt.wav", player)
        elif _re_woohoo.match(msg):
            self.play_sound("sound/player/janet/taunt.wav", player)
        elif _re_quakelive.match(msg):
            self.play_sound("sound/vo_female/quake_live", player)
        elif _re_chaching.search(msg):
            self.play_sound("sound/misc/chaching", player)
        elif _re_uh_ah.match(msg):
            self.play_sound("sound/player/mynx/taunt.wav", player)
        elif _re_oohwee.match(msg):
            self.play_sound("sound/player/anarki/taunt.wav", player)
        elif _re_erah.match(msg):
            self.play_sound("sound/player/bitterman/taunt.wav", player)
        elif _re_yeahhh.match(msg):
            self.play_sound("sound/player/major/taunt.wav", player)
        elif _re_scream.match(msg):
            self.play_sound("sound/player/bones/taunt.wav", player)
        elif _re_salute.match(msg):
            self.play_sound("sound/player/sarge/taunt.wav", player)
        elif _re_squish.match(msg):
            self.play_sound("sound/player/orb/taunt.wav", player)
        elif _re_oh_god.match(msg):
            self.play_sound("sound/player/ranger/taunt.wav", player)
        elif _re_snarl.match(msg):
            self.play_sound("sound/player/sorlag/taunt.wav", player)
